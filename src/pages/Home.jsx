  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" key="description" content="Master Turkish through expert-led boutique group sessions (max 5 students). Focus on natural conversation, logic-based learning, and speaking confidence. Book your free session!" />
