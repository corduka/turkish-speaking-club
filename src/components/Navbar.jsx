...
import { useForm } from '../context/FormContext'; // Doğru import
...
export default function Navbar() {
  const { openForm } = useForm(); // Merkezi form fonksiyonunu aldık
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* 3. Alt Bilgi */}
            <div className="flex-none p-10 text-center text-slate-400 border-t border-slate-50">
